...
const WhoWeAre = () => {
  ...
  return (
    <section className="bg-[#F9FAFB] py-12 md:pt-10 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-start">
          ...
          <div className="order-1">
            ...
            <div className="space-y-4">
              <p className="text-maintext w-[1260px] text-base md:text-lg leading-relaxed">
        ...
        {/* Stats Section */}
        <div className="mt-16 md:mt-14 py-10 bg-white md:bg-transparent rounded-[2rem] md:rounded-none shadow-sm md:shadow-none border border-slate-100 md:border-none grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
